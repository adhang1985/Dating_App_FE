...
const SignatureProfileScreen = ({ navigation, route }) => {
        ...
        <View style={styles.cardContainer}>
          <View style={styles.profileCard}>
            ...
            <Image 
              ...
              onError={(error) => console.log('Signature profile image loading error:', error)}
              onLoad={() => console.log('Signature profile image loaded successfully')}
              resizeMode="cover"
            />
...
export default SignatureProfileScreen;